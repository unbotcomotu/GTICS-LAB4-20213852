...
public interface EmployeeRepository extends JpaRepository<Employee, Integer> {
    ...
    void agregarEmpleado(String nombre,String apellido,String correo,String contrasena,Integer idJob,Double salario,Integer idManager,Integer idDepartment);
    ...
    void cambiarTrabajoPorId(Integer idDepartamento,Integer id);
